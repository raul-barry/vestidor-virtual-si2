...
@Component({
  ...
  template: `<section class="page">
    <div class="toolbar"><h1>Inventario</h1><button mat-flat-button color="primary" (click)="create()">Registrar stock inicial</button></div>
...
export class InventoryListComponent implements OnInit {
  ...
  create(): void { this.dialog.open(InventoryFormComponent, { width: '30rem' }).afterClosed().subscribe((result) => { if (result) { this.updateLocal(result); this.snack.open('Stock inicial registrado', 'Cerrar', { duration: 3000 }); } }); }
