...
@Component({
  ...
  styles: ['.page{padding:2rem}.toolbar,.filters{display:flex;gap:1rem;align-items:center;justify-content:space-between;margin-bottom:1rem}.filters{justify-content:start}table{width:100%}']
})
