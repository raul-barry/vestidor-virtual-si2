...
describe('ProductFormComponent',()=>{
 ...
 beforeEach(async()=>{service=jasmine.createSpyObj<ProductAdminService>('ProductAdminService',['create','update','getById']);await TestBed.configureTestingModule({imports:[ProductFormComponent,NoopAnimationsModule],providers:[{provide:ProductAdminService,useValue:service},{provide:Router,useValue:jasmine.createSpyObj<Router>('Router',['navigate'])},{provide:ActivatedRoute,useValue:{snapshot:{paramMap:convertToParamMap({})}}},{provide:MatSnackBar,useValue:jasmine.createSpyObj<MatSnackBar>('MatSnackBar',['open'])}]}).compileComponents();fixture=TestBed.createComponent(ProductFormComponent);component=fixture.componentInstance;fixture.detectChanges();});
