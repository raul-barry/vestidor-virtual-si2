...
export class ExperienceComponent implements OnInit {
  ...
  mode = ''; rows: any[] = []; recommendationRows: any[] = []; selected: any = null; variantId = 0; bodyProfile: any = null; preferences: any = {}; genericAvatar = false; accessory = false; busy = false; sizeWarning = ''; recommendationMessage = 'Cargando recomendaciones...'; assistantQuery = ''; assistantReply = ''; assistantRows: any[] = []; assistantLoading = false; assistantError = '';
  ...
  selectionChanged(): void { this.selected = null; this.sizeWarning = ''; }
