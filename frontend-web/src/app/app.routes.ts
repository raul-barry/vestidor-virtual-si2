...
export const routes: Routes = [
  ...
  { path: 'pos', canActivate: [authGuard], data: {mode: 'pos', roles: ['ADMINISTRADOR', 'CAJERO']}, loadComponent: () => import('./features/commerce/commerce.component').then(c => c.CommerceComponent) },
